...
const Header = ({drawerRef}) => {
    ...
    return (
        <div className="d-flex align-items-center" style={{width: "100vw", padding: "0px 15px", height: "56px",  fontSize: "60px",}}>
            <Button icon="menu" stylingMode="text" onClick={onClickBtnMenu} style={{display: "flex", alignItems: "center", justifyContent: "center", width: "34px", height: "34px",}} />
            <div style={{alignItems: "center", display: "flex", paddingLeft: "10px",}}>
                <img alt="logo" style={{width: "30px", height: "30px"}} />
